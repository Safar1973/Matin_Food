        ...
        <main class="main-content">
            <div class="header-actions">
                ...
                <div class="d-flex gap-2">
                    <a href="mhd_reports.php?generate=1" class="btn btn-primary rounded-pill px-4 fw-bold"
                        ...
                        <tbody>
                            ...
                            <?php else: ?>
                                    ...
                                    <tr>
                                        ...
                                        <td><?= $r['date'] ?></td>
                                        <td class="text-end">
                                            <a href="<?= htmlspecialchars($r['path']) ?>"
                                                class="btn btn-sm btn-outline-primary rounded-pill px-3" target="_blank">📄
                                                Ansehen</a>
                                            <a href="<?= htmlspecialchars($r['path']) ?>" download
            ...
            <div class="card border-0 shadow-sm rounded-4 mt-4 bg-light">
                <div class="card-body p-4">
                    ...
                    <p class="mb-0">
                        Das System erstellt <strong>jeden Montag (oder beim ersten Login der Woche)</strong> automatisch
                        einen neuen Bericht.
                        In den Berichten werden alle Produkte aufgeführt, deren MHD in den nächsten 30 Tagen abläuft
